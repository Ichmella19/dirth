  ...
  return (
   <section className='  flex-wrap bg-gray-200 justify-center'>
        ...
        <section className="bg-gray-200 w-full min-h-80 relative flex flex-wrap justify-center mt-5 text-2xl">
          ...
          <div className="flex flex-col  px-20 mt-5 font-medium ">
          ...
          <div className="flex flex-col ml-10 md px-20 mt-5 font-medium ">
          ...
          <div className="flex flex-col mr-10 px-20 mt-5 font-medium ">
