   ...
   <nav>
    <div className=" flex  items-center py-8 bg-gray-200">
     ...
     <div className='hidden md:block'>
        ...
        <img src="../src/assets/assets/learning/gauche.png" alt="" className='w-16 h-16 absolute left-[70%] hidden md:flex'/>
         
        <div className='md:hidden flex ' onClick={() => 
           setOpen(!open)}>
         <MdMenu className='text-5xl '/>
         <img src="../src/assets/assets/learning/gauche.png" alt="" className='md:hidden w-14 ml-20'/>
        </div>
    </div>
